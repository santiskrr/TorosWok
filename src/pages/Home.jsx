...
const Inicio = () => {
    ...
    return (
        <div className=" space-y-16 bg-black bg-[url('/public/Fondo.jpg')] bg-cover bg-center bg-fixed mx-w-screen">
            ...
            >
                <div className="relative mx-6 md:mx-20 h-60 rounded-2xl bg-cover bg-center shadow-2xl overflow-hidden">
                    <div className="absolute inset-0 bg-black/0"></div>
                    <div className="absolute inset-0 flex flex-col justify-center items-center text-center">
                        <h1 className="text-5xl font-extrabold text-red-600 px-4 py-2 rounded-lg shadow-xl tracking-wide">
                            Bienvenidos a Toro's Wok
                        </h1>
                        <p className="text-xl text-white px-6 py-2 rounded-lg mt-3 shadow-md tracking-wide">
            ...
            >
                ...
                <div className="text-center md:text-left">
                    <h3 className="text-2xl font-bold text-red-600">Plato Estrella: Ramen Tonkotsu</h3>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}>
                <h3 className="text-2xl font-bold text-red-600 mb-6 text-center">Nuevos Platos</h3>
