    ...
    return (
        <nav className="navegacion relative object-cover rounded-2xl bg-black bg-[url('/public/banner2.jpg')] bg-cover bg-center p-4 items-center shadow-[0_0_5px_#ff0000]">
             ...
             <div className="flex justify-center">
                <Link to="/"><img src={logo}  className="max-h-[100px] h-auto max-w-[100px] w-auto" /></Link>
            </div>
            ...
            <div className="relative flex items-center gap-4 p-2 rounded-lg trade-winds-regular">
                ...
                <Link to="/"><h1 className="flex text-2xl ">Comida Tradicional Asiática</h1></Link>
                </GradientText>
            </div>
            ...
            <div className="relative flex flex-grow justify-center">
                ...
                <ul className="flex gap-10 spectral-sc-regular">
                    ...
                    <li><Link to="/Bebidas" className="text-white shadow-md hover:shadow-blue-200 hover:text-blue-200">Bebidas</Link></li>
                    <li><Link to="/Devs" className="text-white shadow-md hover:shadow-blue-200 hover:text-blue-200">Devs</Link></li>
                </ul>
